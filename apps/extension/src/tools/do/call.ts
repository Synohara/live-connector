    ...
    switch (statement.procedure) {
        ...
        case "transport.seek": {
            ...
            if (typeof beats !== "number") {
                throw new NotFoundError("transport.seek requires a numeric beat position")
            }
            const transport = deps.runtime.requireTransport()
        ...
        case "render.cancel": {
            ...
            if (typeof job_id !== "string") {
                throw new NotFoundError("render.cancel requires a jobId string")
            }
        ...
        default:
            ...
            throw new NotFoundError(`Procedure "${statement.procedure}" is not implemented`)
    }
}
